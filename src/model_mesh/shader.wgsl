...
fn fs_main() {
    ...
    // accumulate color
    var color: vec4<f32> = vec4<f32>(c_ambient, 1.0);
    var i: u32 = 0u;
    ...
    loop {
        ...
        color = color + (diffuse + spec) * object_color * attenuation;
    ...
    loop {
        ...
        color = color + object_color * light.color * (diffuse + spec) * attenuation;
